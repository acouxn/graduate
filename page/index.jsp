		...
		<header class="layout-header">
			...
			<ul class="header-bar">
				...
				<li class="header-bar-nav">
					<a href="javascript:;"><s:property value="#session.existAdmin.username" /><i class="icon-font" style="margin-left:5px;">&#xe60c;</i></a>
					<ul class="header-dropdown-menu">
						<li><a href="javascript:;">个人信息</a></li>
						<li><a href="javascript:;">切换账户</a></li>
						<li><a href="${pageContext.request.contextPath}/admin_logout.action">退出</a></li>
					</ul>
				</li>
				<li class="header-bar-nav"> 
